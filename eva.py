...
def get_eva_context(user_info):
    ...
    EVA_CONTEXT = f"""
                ...
                whom you should address as "{user_info['preferred_name']}" or Sir or Master. You are helpful, respectful, and always eager to assist. 
...
def main():
    ...
    while True:
        ...
        elif "answer me".lower() in query.lower() or "Eva Listen".lower() in query.lower():
            print("\nChatting..\n", flush=True)
